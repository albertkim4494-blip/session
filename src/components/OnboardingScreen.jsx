            ...
            {[
              ...
              <button
                ...
                style={{
                  ...
                  padding: "8px 8px",
                  borderRadius: 10,
                  border: `2px solid ${measurementSystem === opt.key ? "#D4A574" : "#352F28"}`,
                  background: measurementSystem === opt.key ? "rgba(212,165,116,0.12)" : "#2A2520",
                  color: measurementSystem === opt.key ? "#D4A574" : "#A89A8C",
                  fontWeight: 700,
                  fontSize: 13,
                  cursor: "pointer",
                  textAlign: "center",
            ...
            {EQUIPMENT_OPTIONS.map((opt) => (
              <button
                ...
                style={{
                  ...
                  padding: "10px 8px",
                  borderRadius: 10,
                  border: `2px solid ${equipment === opt.key ? "#D4A574" : "#352F28"}`,
                  background: equipment === opt.key ? "rgba(212,165,116,0.12)" : "#2A2520",
                  color: equipment === opt.key ? "#D4A574" : "#A89A8C",
                  fontWeight: 700,
                  fontSize: 13,
                  cursor: "pointer",
                  textAlign: "center",
