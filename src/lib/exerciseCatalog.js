...
export const EXERCISE_CATALOG = [
  ...
  { id: "b-hyperextension", name: "Hyperextension", defaultUnit: "reps", muscles: { primary: ["BACK", "GLUTES"] }, equipment: ["bodyweight"], aliases: ["back extension", "roman chair"], tags: ["isolation", "pull", "bodyweight"], movement: "pull" },
  { id: "b-superman", name: "Superman", defaultUnit: "reps", muscles: { primary: ["BACK", "GLUTES"] }, equipment: ["bodyweight"], aliases: ["back raise", "superman hold"], tags: ["isolation", "pull", "bodyweight"], movement: "pull" },
  ...
  { id: "b-rope-climb", name: "Rope Climb", defaultUnit: "reps", muscles: { primary: ["BACK", "BICEPS"] }, equipment: ["bodyweight"], aliases: ["climbing rope"], tags: ["compound", "pull", "bodyweight"], movement: "pull" },
  ...
  { id: "l-squat-overhead", name: "Overhead Squat", defaultUnit: "reps", muscles: { primary: ["QUADS", "GLUTES"] }, equipment: ["barbell"], aliases: ["oh squat"], tags: ["compound", "legs"], movement: "legs" },
  ...
  { id: "a-reverse-curl", name: "Reverse Curl", defaultUnit: "reps", muscles: { primary: ["BICEPS"] }, equipment: ["barbell", "dumbbell"], aliases: ["reverse curls", "reverse grip curl"], tags: ["isolation", "pull"], movement: "arms" },
  { id: "a-zottman-curl", name: "Zottman Curl", defaultUnit: "reps", muscles: { primary: ["BICEPS"] }, equipment: ["dumbbell"], aliases: ["zottman curls"], tags: ["isolation", "pull"], movement: "arms" },
  ...
  { id: "a-wrist-curl", name: "Wrist Curl", defaultUnit: "reps", muscles: { primary: ["BICEPS"] }, equipment: ["dumbbell", "barbell"], aliases: ["wrist curls", "forearm curl"], tags: ["isolation", "pull"], movement: "arms" },
  { id: "a-reverse-wrist-curl", name: "Reverse Wrist Curl", defaultUnit: "reps", muscles: { primary: ["BICEPS"] }, equipment: ["dumbbell", "barbell"], aliases: ["wrist extension", "forearm extension"], tags: ["isolation", "pull"], movement: "arms" },
  { id: "a-farmers-carry", name: "Farmer's Carry", defaultUnit: "sec", muscles: { primary: ["BACK", "ABS"] }, equipment: ["dumbbell", "kettlebell"], aliases: ["farmer walk", "farmers walk", "loaded carry"], tags: ["compound", "pull"], movement: "arms" },
  ...
  { id: "x-mountain-climber", name: "Mountain Climbers", defaultUnit: "reps", muscles: { primary: ["ABS"] }, equipment: ["bodyweight"], aliases: ["mountain climber", "running plank"], tags: ["cardio", "core", "bodyweight"], movement: "core" },
  { id: "x-bicycle-crunch", name: "Bicycle Crunch", defaultUnit: "reps", muscles: { primary: ["ABS"] }, equipment: ["bodyweight"], aliases: ["bicycle crunches", "cross body crunch"], tags: ["isolation", "core", "bodyweight"], movement: "core" },
  ...
  { id: "x-pallof-press", name: "Pallof Press", defaultUnit: "reps", muscles: { primary: ["ABS"] }, equipment: ["cable"], aliases: ["anti rotation press", "pallof"], tags: ["isolation", "core"], movement: "core" },
  { id: "x-woodchop", name: "Cable Woodchop", defaultUnit: "reps", muscles: { primary: ["ABS"] }, equipment: ["cable"], aliases: ["woodchop", "wood chop", "cable chop"], tags: ["isolation", "core"], movement: "core" },
  ...
  { id: "x-heel-tap", name: "Heel Taps", defaultUnit: "reps", muscles: { primary: ["ABS"] }, equipment: ["bodyweight"], aliases: ["heel touches", "oblique heel tap"], tags: ["isolation", "core", "bodyweight"], movement: "core" },
  ...
  { id: "x-hanging-windshield", name: "Hanging Windshield Wipers", defaultUnit: "reps", muscles: { primary: ["ABS"] }, equipment: ["pull-up bar"], aliases: ["windshield wipers", "hanging wipers"], tags: ["isolation", "core"], movement: "core" },
  ...
  { id: "r-walk-incline", name: "Incline Walking", defaultUnit: "min", muscles: { primary: ["CALVES", "GLUTES"] }, equipment: ["machine"], aliases: ["incline treadmill", "treadmill incline walk"], tags: ["cardio"], movement: "cardio" },
  ...
  { id: "r-swim", name: "Swimming", defaultUnit: "min", muscles: { primary: ["BACK", "CHEST", "ANTERIOR_DELT"] }, equipment: [], aliases: ["swim", "laps swimming"], tags: ["cardio"], movement: "cardio" },
  { id: "r-swim-laps", name: "Lap Swimming", defaultUnit: "laps", muscles: { primary: ["BACK", "ANTERIOR_DELT"] }, equipment: [], aliases: ["swim laps", "pool laps"], tags: ["cardio"], movement: "cardio" },
  ...
  { id: "r-assault-bike", name: "Assault Bike", defaultUnit: "min", muscles: { primary: ["QUADS", "ANTERIOR_DELT"] }, equipment: ["machine"], aliases: ["air bike", "airdyne", "fan bike"], tags: ["cardio", "hiit"], movement: "cardio" },
  { id: "r-ski-erg", name: "Ski Erg", defaultUnit: "min", muscles: { primary: ["BACK", "ABS"] }, equipment: ["machine"], aliases: ["ski ergometer", "skierg"], tags: ["cardio"], movement: "cardio" },
  ...
  { id: "r-butt-kicks", name: "Butt Kicks", defaultUnit: "sec", muscles: { primary: ["HAMSTRINGS"] }, equipment: ["bodyweight"], aliases: ["butt kick run"], tags: ["cardio", "bodyweight"], movement: "cardio" },
  { id: "r-box-jump-cardio", name: "Box Jumps (Cardio)", defaultUnit: "reps", muscles: { primary: ["QUADS", "CALVES"] }, equipment: ["bodyweight"], aliases: ["plyo box jump"], tags: ["cardio", "bodyweight", "hiit"], movement: "cardio" },

  // ===========================================================================
  // SPORT / ATHLETIC
  // ===========================================================================
  { id: "sp-basketball", name: "Basketball", defaultUnit: "min", muscles: { primary: ["QUADS", "CALVES", "GLUTES"] }, equipment: [], aliases: ["basketball practice", "hoops"], tags: ["sport"], movement: "sport" },
  { id: "sp-soccer", name: "Soccer", defaultUnit: "min", muscles: { primary: ["QUADS", "HAMSTRINGS", "CALVES"] }, equipment: [], aliases: ["soccer practice", "football (soccer)"], tags: ["sport"], movement: "sport" },
  { id: "sp-football", name: "Football", defaultUnit: "min", muscles: { primary: ["QUADS", "GLUTES", "HAMSTRINGS"] }, equipment: [], aliases: ["football practice", "american football"], tags: ["sport"], movement: "sport" },
  { id: "sp-tennis", name: "Tennis", defaultUnit: "min", muscles: { primary: ["QUADS", "ANTERIOR_DELT", "CALVES"] }, equipment: [], aliases: ["tennis practice", "tennis match"], tags: ["sport"], movement: "sport" },
  { id: "sp-badminton", name: "Badminton", defaultUnit: "min", muscles: { primary: ["QUADS", "ANTERIOR_DELT", "CALVES"] }, equipment: [], aliases: ["badminton match", "shuttlecock"], tags: ["sport"], movement: "sport" },
  { id: "sp-table-tennis", name: "Table Tennis", defaultUnit: "min", muscles: { primary: ["ANTERIOR_DELT", "ABS"] }, equipment: [], aliases: ["ping pong", "table tennis match"], tags: ["sport"], movement: "sport" },
  { id: "sp-pickleball", name: "Pickleball", defaultUnit: "min", muscles: { primary: ["QUADS", "ANTERIOR_DELT", "CALVES"] }, equipment: [], aliases: ["pickleball match"], tags: ["sport"], movement: "sport" },
  { id: "sp-racquetball", name: "Racquetball", defaultUnit: "min", muscles: { primary: ["QUADS", "ANTERIOR_DELT", "CALVES"] }, equipment: [], aliases: ["racquetball match", "squash"], tags: ["sport"], movement: "sport" },
  { id: "sp-squash", name: "Squash", defaultUnit: "min", muscles: { primary: ["QUADS", "ANTERIOR_DELT", "CALVES"] }, equipment: [], aliases: ["squash match"], tags: ["sport"], movement: "sport" },
  { id: "sp-polo", name: "Water Polo", defaultUnit: "min", muscles: { primary: ["ANTERIOR_DELT", "BACK", "CHEST"] }, equipment: [], aliases: ["polo", "water polo practice"], tags: ["sport"], movement: "sport" },
  { id: "sp-volleyball", name: "Volleyball", defaultUnit: "min", muscles: { primary: ["QUADS", "ANTERIOR_DELT", "CALVES"] }, equipment: [], aliases: ["volleyball practice"], tags: ["sport"], movement: "sport" },
  { id: "sp-baseball", name: "Baseball", defaultUnit: "min", muscles: { primary: ["ANTERIOR_DELT", "ABS", "QUADS"] }, equipment: [], aliases: ["baseball practice", "batting practice"], tags: ["sport"], movement: "sport" },
  { id: "sp-softball", name: "Softball", defaultUnit: "min", muscles: { primary: ["ANTERIOR_DELT", "ABS", "QUADS"] }, equipment: [], aliases: ["softball practice"], tags: ["sport"], movement: "sport" },
  { id: "sp-hockey", name: "Hockey", defaultUnit: "min", muscles: { primary: ["QUADS", "GLUTES", "ABS"] }, equipment: [], aliases: ["ice hockey", "hockey practice", "field hockey"], tags: ["sport"], movement: "sport" },
  { id: "sp-lacrosse", name: "Lacrosse", defaultUnit: "min", muscles: { primary: ["QUADS", "ANTERIOR_DELT", "ABS"] }, equipment: [], aliases: ["lacrosse practice", "lax"], tags: ["sport"], movement: "sport" },
  { id: "sp-rugby", name: "Rugby", defaultUnit: "min", muscles: { primary: ["QUADS", "GLUTES", "HAMSTRINGS"] }, equipment: [], aliases: ["rugby practice", "rugby match"], tags: ["sport"], movement: "sport" },
  { id: "sp-cricket", name: "Cricket", defaultUnit: "min", muscles: { primary: ["QUADS", "ANTERIOR_DELT", "ABS"] }, equipment: [], aliases: ["cricket practice", "cricket match"], tags: ["sport"], movement: "sport" },
  { id: "sp-golf", name: "Golf", defaultUnit: "min", muscles: { primary: ["ABS", "BACK", "GLUTES"] }, equipment: [], aliases: ["golf round", "driving range"], tags: ["sport"], movement: "sport" },
  { id: "sp-boxing", name: "Boxing", defaultUnit: "min", muscles: { primary: ["ANTERIOR_DELT", "ABS", "TRICEPS"] }, equipment: [], aliases: ["boxing training", "heavy bag"], tags: ["sport"], movement: "sport" },
  { id: "sp-kickboxing", name: "Kickboxing", defaultUnit: "min", muscles: { primary: ["QUADS", "ANTERIOR_DELT", "ABS"] }, equipment: [], aliases: ["kickboxing class", "muay thai"], tags: ["sport"], movement: "sport" },
  { id: "sp-mma", name: "MMA Training", defaultUnit: "min", muscles: { primary: ["QUADS", "ABS", "BACK"] }, equipment: [], aliases: ["martial arts", "mma"], tags: ["sport"], movement: "sport" },
  { id: "sp-bjj", name: "Brazilian Jiu-Jitsu", defaultUnit: "min", muscles: { primary: ["BACK", "ABS", "GLUTES"] }, equipment: [], aliases: ["bjj", "jiu jitsu", "grappling"], tags: ["sport"], movement: "sport" },
  { id: "sp-karate", name: "Karate", defaultUnit: "min", muscles: { primary: ["QUADS", "ABS", "ANTERIOR_DELT"] }, equipment: [], aliases: ["karate practice", "karate class"], tags: ["sport"], movement: "sport" },
  { id: "sp-judo", name: "Judo", defaultUnit: "min", muscles: { primary: ["BACK", "ABS", "GLUTES"] }, equipment: [], aliases: ["judo practice", "judo class"], tags: ["sport"], movement: "sport" },
  { id: "sp-taekwondo", name: "Taekwondo", defaultUnit: "min", muscles: { primary: ["QUADS", "HAMSTRINGS", "ABS"] }, equipment: [], aliases: ["tkd", "tae kwon do"], tags: ["sport"], movement: "sport" },
  { id: "sp-wrestling", name: "Wrestling", defaultUnit: "min", muscles: { primary: ["BACK", "QUADS", "ABS"] }, equipment: [], aliases: ["wrestling practice"], tags: ["sport"], movement: "sport" },
  { id: "sp-fencing", name: "Fencing", defaultUnit: "min", muscles: { primary: ["QUADS", "CALVES", "ANTERIOR_DELT"] }, equipment: [], aliases: ["fencing practice", "epee", "foil", "sabre"], tags: ["sport"], movement: "sport" },
  { id: "sp-climbing", name: "Rock Climbing", defaultUnit: "min", muscles: { primary: ["BACK", "BICEPS"] }, equipment: [], aliases: ["climbing", "bouldering", "sport climbing", "indoor climbing"], tags: ["sport"], movement: "sport" },
  { id: "sp-surfing", name: "Surfing", defaultUnit: "min", muscles: { primary: ["BACK", "ANTERIOR_DELT", "ABS"] }, equipment: [], aliases: ["surf", "surf session"], tags: ["sport"], movement: "sport" },
  { id: "sp-skiing", name: "Skiing", defaultUnit: "min", muscles: { primary: ["QUADS"] }, equipment: [], aliases: ["ski", "downhill skiing", "alpine skiing"], tags: ["sport"], movement: "sport" },
  { id: "sp-snowboarding", name: "Snowboarding", defaultUnit: "min", muscles: { primary: ["QUADS"] }, equipment: [], aliases: ["snowboard"], tags: ["sport"], movement: "sport" },
  { id: "sp-xc-ski", name: "Cross-Country Skiing", defaultUnit: "min", muscles: { primary: ["QUADS", "GLUTES", "BACK"] }, equipment: [], aliases: ["xc skiing", "nordic skiing"], tags: ["sport", "cardio"], movement: "sport" },
  { id: "sp-skateboarding", name: "Skateboarding", defaultUnit: "min", muscles: { primary: ["QUADS", "CALVES", "ABS"] }, equipment: [], aliases: ["skate", "skating"], tags: ["sport"], movement: "sport" },
  { id: "sp-rowing-sport", name: "Rowing (Sport)", defaultUnit: "min", muscles: { primary: ["BACK", "QUADS"] }, equipment: [], aliases: ["crew", "sculling", "rowing team"], tags: ["sport", "cardio"], movement: "sport" },
  { id: "sp-gymnastics", name: "Gymnastics", defaultUnit: "min", muscles: { primary: ["ABS", "QUADS", "ANTERIOR_DELT"] }, equipment: [], aliases: ["gymnastics practice", "gymnastics class"], tags: ["sport"], movement: "sport" },
  { id: "sp-dance", name: "Dance", defaultUnit: "min", muscles: { primary: ["QUADS", "CALVES", "GLUTES"] }, equipment: [], aliases: ["dance class", "dance practice", "dancing", "ballet", "salsa", "hip hop dance"], tags: ["sport"], movement: "sport" },
  { id: "sp-handball", name: "Handball", defaultUnit: "min", muscles: { primary: ["QUADS", "ANTERIOR_DELT", "ABS"] }, equipment: [], aliases: ["handball match"], tags: ["sport"], movement: "sport" },
  { id: "sp-ultimate", name: "Ultimate Frisbee", defaultUnit: "min", muscles: { primary: ["QUADS", "HAMSTRINGS", "ANTERIOR_DELT"] }, equipment: [], aliases: ["ultimate", "frisbee"], tags: ["sport"], movement: "sport" },
  { id: "sp-crossfit", name: "CrossFit", defaultUnit: "min", muscles: { primary: ["QUADS", "BACK", "ABS"] }, equipment: [], aliases: ["crossfit wod", "wod", "metcon"], tags: ["sport"], movement: "sport" },
  { id: "sp-track", name: "Track & Field", defaultUnit: "min", muscles: { primary: ["QUADS", "HAMSTRINGS", "GLUTES"] }, equipment: [], aliases: ["track practice", "sprinting", "hurdles", "javelin", "shot put"], tags: ["sport"], movement: "sport" },
  ...
  { id: "m-pilates", name: "Pilates", defaultUnit: "min", muscles: { primary: ["ABS"] }, equipment: [], aliases: ["pilates class", "mat pilates", "reformer pilates"], tags: ["mobility", "core"], movement: "mobility" },
