...
export const EXERCISE_CATALOG = [
  ...
  { id: "r-run-outdoor", name: "Outdoor Running", defaultUnit: "min", muscles: { primary: [] }, equipment: [], aliases: ["outdoor run", "road running", "trail running"], tags: ["cardio"], movement: "cardio" },
  ...
  { id: "r-bike-outdoor", name: "Outdoor Cycling", defaultUnit: "min", muscles: { primary: [] }, equipment: [], aliases: ["road bike", "bike ride", "cycling outdoor"], tags: ["cardio"], movement: "cardio" },
  ...
  { id: "r-assault-bike", name: "Assault Bike", defaultUnit: "min", muscles: { primary: [] }, equipment: ["machine"], aliases: ["air bike", "airdyne", "fan bike"], tags: ["cardio", "hiit"], movement: "cardio" },
  ...
  { id: "r-jumping-jack", name: "Jumping Jacks", defaultUnit: "reps", muscles: { primary: [] }, equipment: ["bodyweight"], aliases: ["jumping jacks", "star jumps"], tags: ["cardio", "bodyweight"], movement: "cardio" },
  ...
  { id: "sp-football", name: "Football", defaultUnit: "min", muscles: { primary: [] }, equipment: [], aliases: ["football practice", "american football"], tags: ["sport"], movement: "sport" },
  ...
  { id: "sp-badminton", name: "Badminton", defaultUnit: "min", muscles: { primary: [] }, equipment: [], aliases: ["badminton match", "shuttlecock"], tags: ["sport"], movement: "sport" },
  { id: "sp-table-tennis", name: "Table Tennis", defaultUnit: "min", muscles: { primary: [] }, equipment: [], aliases: ["ping pong", "table tennis match"], tags: ["sport"], movement: "sport" },
  { id: "sp-pickleball", name: "Pickleball", defaultUnit: "min", muscles: { primary: [] }, equipment: [], aliases: ["pickleball match"], tags: ["sport"], movement: "sport" },
  { id: "sp-racquetball", name: "Racquetball", defaultUnit: "min", muscles: { primary: [] }, equipment: [], aliases: ["racquetball match", "squash"], tags: ["sport"], movement: "sport" },
  { id: "sp-squash", name: "Squash", defaultUnit: "min", muscles: { primary: [] }, equipment: [], aliases: ["squash match"], tags: ["sport"], movement: "sport" },
  ...
  { id: "sp-baseball", name: "Baseball", defaultUnit: "min", muscles: { primary: [] }, equipment: [], aliases: ["baseball practice", "batting practice"], tags: ["sport"], movement: "sport" },
  { id: "sp-softball", name: "Softball", defaultUnit: "min", muscles: { primary: [] }, equipment: [], aliases: ["softball practice"], tags: ["sport"], movement: "sport" },
  { id: "sp-hockey", name: "Hockey", defaultUnit: "min", muscles: { primary: [] }, equipment: [], aliases: ["ice hockey", "hockey practice", "field hockey"], tags: ["sport"], movement: "sport" },
  { id: "sp-lacrosse", name: "Lacrosse", defaultUnit: "min", muscles: { primary: [] }, equipment: [], aliases: ["lacrosse practice", "lax"], tags: ["sport"], movement: "sport" },
  { id: "sp-rugby", name: "Rugby", defaultUnit: "min", muscles: { primary: [] }, equipment: [], aliases: ["rugby practice", "rugby match"], tags: ["sport"], movement: "sport" },
  { id: "sp-cricket", name: "Cricket", defaultUnit: "min", muscles: { primary: [] }, equipment: [], aliases: ["cricket practice", "cricket match"], tags: ["sport"], movement: "sport" },
  { id: "sp-golf", name: "Golf", defaultUnit: "min", muscles: { primary: [] }, equipment: [], aliases: ["golf round", "driving range"], tags: ["sport"], movement: "sport" },
  ...
  { id: "sp-kickboxing", name: "Kickboxing", defaultUnit: "min", muscles: { primary: [] }, equipment: [], aliases: ["kickboxing class", "muay thai"], tags: ["sport"], movement: "sport" },
  { id: "sp-mma", name: "MMA Training", defaultUnit: "min", muscles: { primary: [] }, equipment: [], aliases: ["martial arts", "mma"], tags: ["sport"], movement: "sport" },
  { id: "sp-bjj", name: "Brazilian Jiu-Jitsu", defaultUnit: "min", muscles: { primary: [] }, equipment: [], aliases: ["bjj", "jiu jitsu", "grappling"], tags: ["sport"], movement: "sport" },
  { id: "sp-karate", name: "Karate", defaultUnit: "min", muscles: { primary: [] }, equipment: [], aliases: ["karate practice", "karate class"], tags: ["sport"], movement: "sport" },
  { id: "sp-judo", name: "Judo", defaultUnit: "min", muscles: { primary: [] }, equipment: [], aliases: ["judo practice", "judo class"], tags: ["sport"], movement: "sport" },
  { id: "sp-taekwondo", name: "Taekwondo", defaultUnit: "min", muscles: { primary: [] }, equipment: [], aliases: ["tkd", "tae kwon do"], tags: ["sport"], movement: "sport" },
  ...
  { id: "sp-fencing", name: "Fencing", defaultUnit: "min", muscles: { primary: [] }, equipment: [], aliases: ["fencing practice", "epee", "foil", "sabre"], tags: ["sport"], movement: "sport" },
  ...
  { id: "sp-surfing", name: "Surfing", defaultUnit: "min", muscles: { primary: [] }, equipment: [], aliases: ["surf", "surf session"], tags: ["sport"], movement: "sport" },
  ...
  { id: "sp-xc-ski", name: "Cross-Country Skiing", defaultUnit: "min", muscles: { primary: [] }, equipment: [], aliases: ["xc skiing", "nordic skiing"], tags: ["sport", "cardio"], movement: "sport" },
  { id: "sp-skateboarding", name: "Skateboarding", defaultUnit: "min", muscles: { primary: [] }, equipment: [], aliases: ["skate", "skating"], tags: ["sport"], movement: "sport" },
  ...
  { id: "sp-gymnastics", name: "Gymnastics", defaultUnit: "min", muscles: { primary: [] }, equipment: [], aliases: ["gymnastics practice", "gymnastics class"], tags: ["sport"], movement: "sport" },
  { id: "sp-dance", name: "Dance", defaultUnit: "min", muscles: { primary: [] }, equipment: [], aliases: ["dance class", "dance practice", "dancing", "ballet", "salsa", "hip hop dance"], tags: ["sport"], movement: "sport" },
  { id: "sp-handball", name: "Handball", defaultUnit: "min", muscles: { primary: [] }, equipment: [], aliases: ["handball match"], tags: ["sport"], movement: "sport" },
  { id: "sp-ultimate", name: "Ultimate Frisbee", defaultUnit: "min", muscles: { primary: [] }, equipment: [], aliases: ["ultimate", "frisbee"], tags: ["sport"], movement: "sport" },
  { id: "sp-crossfit", name: "CrossFit", defaultUnit: "min", muscles: { primary: [] }, equipment: [], aliases: ["crossfit wod", "wod", "metcon"], tags: ["sport"], movement: "sport" },
  { id: "sp-track", name: "Track & Field", defaultUnit: "min", muscles: { primary: [] }, equipment: [], aliases: ["track practice", "sprinting", "hurdles", "javelin", "shot put"], tags: ["sport"], movement: "sport" },
  ...
  { id: "m-yoga-power", name: "Power Yoga", defaultUnit: "min", muscles: { primary: [] }, equipment: [], aliases: ["power yoga", "vinyasa"], tags: ["mobility", "flexibility"], movement: "mobility" },
  { id: "m-yoga-hot", name: "Hot Yoga", defaultUnit: "min", muscles: { primary: [] }, equipment: [], aliases: ["bikram", "hot yoga class"], tags: ["mobility", "flexibility"], movement: "mobility" },
  ...
  { id: "m-dynamic-warmup", name: "Dynamic Warm-Up", defaultUnit: "min", muscles: { primary: [] }, equipment: ["bodyweight"], aliases: ["warm up", "warmup", "dynamic stretch"], tags: ["mobility"], movement: "mobility" },
  { id: "m-tai-chi", name: "Tai Chi", defaultUnit: "min", muscles: { primary: [] }, equipment: [], aliases: ["tai chi class", "taichi"], tags: ["mobility", "flexibility"], movement: "mobility" },
  ...
  { id: "s-neck-tilt", name: "Neck Side Tilt Stretch", defaultUnit: "sec", muscles: { primary: [] }, equipment: ["bodyweight"], aliases: ["neck stretch", "lateral neck stretch", "neck tilt"], tags: ["stretch", "isometric", "bodyweight"], movement: "stretch" },
  { id: "s-neck-rotation", name: "Neck Rotation Stretch", defaultUnit: "sec", muscles: { primary: [] }, equipment: ["bodyweight"], aliases: ["neck rotation", "neck turn"], tags: ["stretch", "isometric", "bodyweight"], movement: "stretch" },
  { id: "s-wrist-flexor", name: "Wrist Flexor Stretch", defaultUnit: "sec", muscles: { primary: [] }, equipment: ["bodyweight"], aliases: ["wrist stretch", "forearm flexor stretch"], tags: ["stretch", "isometric", "bodyweight"], movement: "stretch" },
  { id: "s-wrist-extensor", name: "Wrist Extensor Stretch", defaultUnit: "sec", muscles: { primary: [] }, equipment: ["bodyweight"], aliases: ["reverse wrist stretch", "forearm extensor stretch"], tags: ["stretch", "isometric", "bodyweight"], movement: "stretch" },
